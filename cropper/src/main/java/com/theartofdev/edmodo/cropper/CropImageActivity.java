...
public class CropImageActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            if (getIntent().hasExtra(CropImage.CROP_IMAGE_EXTRA_SOURCE)) {
                mCropImageUri = getIntent().getExtras().getParcelable(CropImage.CROP_IMAGE_EXTRA_SOURCE);

            }
            if (getIntent().hasExtra(CropImage.CROP_IMAGE_EXTRA_OPTIONS)) {
                mOptions = getIntent().getExtras().getParcelable(CropImage.CROP_IMAGE_EXTRA_OPTIONS);
